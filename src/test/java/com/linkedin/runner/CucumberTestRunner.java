...
@CucumberOptions( // CucumberOptions annotation - Cucumber test konfiqurasiyası
    ...
    plugin = { // Plugin-lər - Report formatları və Allure inteqrasiyası
        ...
        "html:target/cucumber-reports", // HTML report - HTML formatında report
        "json:target/cucumber-reports/cucumber.json", // JSON report - JSON formatında report
        "junit:target/cucumber-reports/cucumber.xml" // JUnit XML report - JUnit XML formatında report
    },
...
public class CucumberTestRunner extends AbstractTestNGCucumberTests { // CucumberTestRunner class - TestNG ilə Cucumber runner
