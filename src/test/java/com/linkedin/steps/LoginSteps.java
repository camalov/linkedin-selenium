...
public class LoginSteps { // LoginSteps class - Cucumber step definitions üçün
    ...
    public void i_am_on_linkedin_login_page() { // Given step metodunun implementasiyası
        ...
        // options.addArguments("--headless"); // LinkedIn bot detection üçün headless mode deaktivdir
        driver = new ChromeDriver(options); // ChromeDriver-i yarat
        Hooks.setDriver(driver); // Hooks class-ında driver-i təyin et
    ...
    public void i_login_with_username_and_password(String username, String password) { // When step metodunun implementasiyası
    ...
    public void i_should_see_error_message_containing(String expectedText) { // Then step metodunun implementasiyası
        ...
        Assert.assertTrue(errorText.contains(expectedText), // Assert - error mesajında gözlənilən mətnin olub-olmadığını yoxla
    ...
    public void i_should_see_page_title_contains(String expectedText) { // Then step metodunun implementasiyası
        ...
        Assert.assertTrue(pageTitle.contains(expectedText), // Assert - page title-də gözlənilən mətnin olub-olmadığını yoxla
